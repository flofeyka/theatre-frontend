...
export default function ContactsHeader() {
    return <header className="flex border-t-2 border-black border-solid">
        <div className="flex flex-col px-8 py-10 w-[40vw] justify-between bg-[#B8AF9E] border-solid border-r-2 border-black">
        ...
        <div className="w-[60vw] bg-[#FFC224] p-5 border-r-2 border-black ">
